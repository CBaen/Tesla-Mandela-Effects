...
4. **VOICE_REFERENCE.txt** — Episode 002 "The White City," the v4 style exemplar. The excerpt shows the opening; read the full episode script at `EPISODES/002 - THE WHITE CITY/002-THE_WHITE_CITY-SCRIPT-v4.md` before writing. Study it for embodied investigation, narrator discovery stance, and fabricated source craft. Do not clone its content or structure.
