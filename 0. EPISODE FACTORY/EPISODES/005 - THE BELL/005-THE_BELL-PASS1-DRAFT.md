...
These have been documented not only by amateur observers but by professional astronomers using institutional instruments. The Royal Astronomical Society holds accounts from the eighteenth and nineteenth centuries. Modern observatories have captured the light flashes on photographic plates. The record is not anecdote — it is documentation, accumulated across multiple centuries, multiple observational traditions, multiple cultures looking at the same object.

The Aristarchus crater region generates a disproportionate percentage of reports. Aristarchus is already anomalously bright — one of the most reflective features on the lunar surface. It is also a region of elevated titanium concentration in the regolith. The correlation between the reporting hotspot and the material concentration is noted in the scientific literature. What it means has not been settled.

The phenomena could be outgassing — volatile compounds from some interior source escaping through cracks in the surface as the Moon's temperature cycles. They could be electrostatic events, charged particles interacting with the regolith in ways that produce light. No single explanation satisfies all two thousand two hundred documented cases.
