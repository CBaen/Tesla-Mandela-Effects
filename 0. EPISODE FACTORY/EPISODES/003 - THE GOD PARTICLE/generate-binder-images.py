"""
Episode 003 "The God Particle" — Gemini 3.1 Flash Image Generator
Theme: Multiverse artifacts, advanced non-human evidence, inter-dimensional technology
...
SEQUENCE_FILE = os.path.join(EPISODE_DIR, '003-VISUAL-TIMED-SEQUENCE-v3.json')
...
STYLE: Inter-dimensional evidence archive. More advanced and alien than human. Crystalline fragments, iridescent materials, impossible geometric artifacts alongside vintage photographs and aged documents. The investigator collecting this evidence is not entirely human. Kodachrome vivid colors. Photorealistic flat lay. No readable text. 16:9."""
...
print(f"Episode 003 — Gemini 3.1 Flash (Multiverse/Inter-dimensional theme)")
