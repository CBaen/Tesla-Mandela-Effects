...
In the fever, the visions came differently. Not the childhood images — these were chaos. Dane appeared in the doorway, reaching, and Nikola tried to speak but had no voice. Then the fever broke for a moment and the visions receded and he understood where he was and why his mother was crying silently into her hands. When the fever returned, Dane was gone again.

At some point during those nine months, Milutin made a bargain. If the boy survived, the boy would not join the priesthood. Engineering. Medicine. Any path that was not the church. The boy could choose. Just let the boy live.
...
But here is the inversion. Here is the turn that the investigation must now make. This was never only about Dane Tesla. This was about the shape of what is missing.

Have you ever reached for someone who was not there? A person on your left. A person who was supposed to be in the room with you, supposed to be singing when you drew machines, supposed to be drawing when you sang. A person whose absence you built an entire life around — the way Tesla built his. Arranging yourself according to that absence. Making room for the empty chair. Reaching toward a position where nothing reaches back.

And calling it acceptance. Calling it survival. Calling it the way your life turned out. What if you are carrying the shape of an amputation? The shape of something that is supposed to be there but is not.
...
Church → Church → /CH ER1 CH/
of → of → /AH0 V/
Great → Great → /G R EY1 T/
Martyr → Martyr → /M AA1 R T ER0/
George → George → /JH AO1 R JH/
Angelina → Angelina → /AA0 N G EH0 L IY1 N AA0/
Milka → Milka → /M IY1 L K AA0/
Marica → Marica → /M AA0 R IY1 T S AA0/
Wilbur → Wilbur → /W IH1 L B ER0/
Wright → Wright → /R AY1 T/
Orville → Orville → /AO1 R V IH0 L/
Joseph-Michel → Joseph-Michel → /ZH OW0 Z EH1 F M IY0 SH EH1 L/
Montgolfier → Montgolfier → /M AO0 N G AO1 L F Y EH0/
Jacques-Étienne → Jacques-Etienne → /ZH AA1 K EH0 T Y EH1 N/
Austrian → Austrian → /AO1 S T R IY0 AH0 N/
Polytechnic → Polytechnic → /P AA0 L IY0 T EH1 K N IH0 K/
Graz → Graz → /G R AA1 T S/
J.P. → J.P. → /JH EY1 P IY1/
Morgan → Morgan → /M AO1 R G AH0 N/
Edison → Edison → /EH1 D IH0 S AH0 N/
Westinghouse → Westinghouse → /W EH1 S T IH0 NG HH AW1 Z/
New → New → /N UW1/
Yorker → Yorker → /Y AO1 R K ER0/
Hotel → Hotel → /HH OW0 T EH1 L/
Office → Office → /AO1 F IH0 S/
Alien → Alien → /EY1 L IY0 AH0 N/
Property → Property → /P R AA1 P ER0 T IY0/
Room → Room → /R UW1 M/
thirty-three → thirty-three → /TH ER1 T IY0 TH R IY1/
twenty-seven → twenty-seven → /T W EH1 N T IY0 S EH1 V AH0 N/
Museum → Museum → /M Y UW0 Z IY1 AH0 M/
Belgrade → Belgrade → /B EH1 L G R EY0 D/
FBI → FBI → /EH1 F B IY1 AY1/
Colorado → Colorado → /K AA0 L AH0 R AE1 D OW0/
Springs → Springs → /S P R IH1 NG Z/
Long → Long → /L AO1 NG/
Island → Island → /AY1 L AH0 N D/
Wardenclyffe → Wardenclyffe → /W AO1 R D AH0 N K L IH1 F/
Austro-Hungarian → Austro-Hungarian → /AO1 S T R OW0 HH AH1 N G EH1 R IY0 AH0 N/
Empire → Empire → /EH1 M P AY1 R/
M.K. → M.K. → /EH1 M K EY1/
Gračac → Gracac → /G R AA1 CH AA0 T S/
Mandić → Mandic → /M AA1 N D IY0 CH/
My → My → /M AY1/
Inventions → Inventions → /IH0 N V EH1 N SH AH0 N Z/
