...
- **Structural shape:** Chronological spiral (1899 → present, each pass adds a new evidence layer)
- **Closing type:** The Mirror — listener asked if they are the scar, the residue of an overwritten version
- **Emotional endpoint:** Existential dread — "are you the original or the copy?"
- **Tesla connection type:** Experiment consequence (Colorado Springs frequency → CERN unknowingly continues the resonance work)
- **Tesla presence:** Direct appearance (Colorado Springs 1899, Wardenclyffe 1901-1917, death 1943)
- **Key locations:** Colorado Springs, Shoreham/Long Island, CERN/Meyrin, New Yorker Hotel Manhattan
- **Key experiments:** Colorado Springs magnifying transmitter, Wardenclyffe Tower, LHC particle collisions
- **Mandela Effects (primary):** Berenstain Bears, Fruit of the Loom cornucopia, Monopoly Man monocle, "Luke I am your father"
- **Fabricated sources:** Classified internal memo (Frequency Discrepancy Report), geological survey (Colorado Springs soil), monitoring station log (Schumann Deviation Log, Tromsø), anonymous insider letter (calibration engineer)
- **Key images (DO NOT REUSE in next 3 episodes):**
  - "tourniquet around a limb that was losing blood"
  - "a splinter the body cannot dissolve"
  - "gauze being drawn across a wound"
  - "suture around something that needed to be closed"
  - "the place where certainty lives"
  - "a painting without a canvas"
  - "the ground remembers something that happened to it"
  - "something that had been interrupted mid-sentence"
  - "the baseline moved"
...
- **Closing type:** The Witness — Gospic oral history transcript (M.K.'s grandmother's testimony through three generations of transmission) closes the episode; investigation turns outward to listener with personal unanswerable question
...
- **Fabricated sources:** Patent application photograph from New Haven estate auction (2003) — two applicant names, N. Tesla + D.—sla, March 1891, Electrical Transmission Resonant; second photograph from same lot — laboratory interior, two men, one at blackboard writing in hand that is not Tesla's (photographic evidence with provenance gaps); OAP inventory discrepancy, Item 1247 — "D. Tesla — correspondence, three items" + "Vol. XII removed for separate review — handwriting inconsistency" (declassified government report/annotation); Djuka Tesla letter to cousin in Gracac, 1865 — Dane's machine drawings in two different handwritings (institutional correspondence/family document); Lika Cultural Documentation Society oral history, 1981, Gospic — M.K. (age 94) insists grandmother saw two Tesla boys at church: "the quiet one drew machines, the loud one sang" (oral history/recorded interview transcript)
- **Key images (DO NOT REUSE in next 3 episodes):**
