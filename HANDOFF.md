...
- **Use subagents for writing passes.** Main context is for coordination and verification only.
...
- **Term Violations Definition** at `0. EPISODE FACTORY/TERM_VIOLATIONS_DEFINITION.md`. Three categories.

## Document Parity

| Document | Location | Last Updated |
|----------|----------|-------------|
| Production Guide | `0. EPISODE FACTORY/PRODUCTION_GUIDE.md` | 2026-02-16 |
...
| Session Memory | `C:\Users\baenb\.claude\projects\C--Users-baenb-Desktop-Tesla-Mandela-Effects\memory\MEMORY.md` | 2026-02-22 |
| Handoff | `HANDOFF.md` | 2026-02-22 |
