...
- [x] Narrative structure expedition — 8 research teams + 2 validators (findings in research/expedition-narrative-structure/)
- [x] Genre reframing: NOT a conspiracy show → faux-historical documentary from parallel timeline
...
- [x] Episode Factory skill created and tested (3 episodes: 008, 009, 010)

## Completed (2026-02-23)
- [x] Production Guide written
- [x] Caption Key system established
- [x] Release Strategy created
- [x] Standalone Rule established

## Completed (2026-02-13)
- [x] Audit all existing instruction files (28 files, 8+ versions)
- [x] Analyze Episode 001 and Episode 002
- [x] Resolve 5 key contradictions
- [x] Research Opus 4.6 instruction compliance
- [x] Research long-form output quality and multi-pass workflow
- [x] Write and refine EPISODE_PRODUCTION_GUIDE.md
- [x] Guiding Light review and editing pass
- [x] Log all decisions
